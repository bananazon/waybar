...
### Software Updates
This module displays the number of available outputs for the following package managers: `apk`, `apt`, `brew`, `dnf`, `emerge`, `mintupdate`, `pacman`, `snap`, `xbps`, `yay`, `yay-aur`, `yum`. Please see the [`permissions`](#permissions) section before implementing this module.
